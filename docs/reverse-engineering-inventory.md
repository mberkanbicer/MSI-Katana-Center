...
| Webcam on/off | msi-ec `webcam` `0x2e` | live `on`, RW | gated writes (unverified) |
| Webcam block | msi-ec `webcam_block` `0x2f` | live `off`, RW | gated writes (unverified) |
| Fn/Win swap | msi-ec `fn_key`/`win_key` `0xe8` | Fn right / Win left, RW | gated `SetFnKey` (unverified) |
